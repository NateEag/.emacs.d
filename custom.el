(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (jq-mode string-edit rjsx-mode aggressive-fill-paragraph evil-magit evil-matchit evil-surround flycheck-css-colorguard js2-refactor helm-ag ag magit nginx-mode notmuch lorem-ipsum with-editor web-mode git-blamed regex-tool async dash s virtualenvwrapper use-package undo-tree term-manager projectile term-projectile solarized-theme macrostep slime f python-mode puppet-mode pip-requirements omnisharp multiple-cursors markdown-mode helm-projectile groovy-mode flycheck-package expand-region evil-commentary beacon aggressive-indent ace-window evil-escape yaml-mode writeroom-mode unicode-troll-stopper toggle-quotes tern-auto-complete tea-time tagedit sublimity string-inflection speed-type smartparens smart-tabs-mode skewer-reload-stylesheets scss-mode sane-term rainbow-mode pyimpsort pyenv-mode popwin php-auto-yasnippets names multi-term mocha-snippets mo-git-blame minimap md-readme literate-coffee-mode know-your-http-well key-chord json-mode jscs js-doc jedi iss-mode hideshowvis helm-swoop helm-ls-git helm-git-files gitignore-mode gitconfig-mode gitattributes-mode git-timemachine frame-cmds focus-autosave-mode exec-path-from-shell evil-tutor evil-leader evil-indent-textobject evil-exchange esup elisp-slime-nav el2markdown editorconfig diffview cygwin-mount cycle-quotes compact-docstrings cask-mode buttercup browse-url-dwim browse-kill-ring bats-mode backup-walker auto-compile ascii apache-mode ace-jump-mode ac-slime ac-ispell ac-html-csswatcher ac-html ac-helm ac-emmet)))
