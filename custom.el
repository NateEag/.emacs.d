(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    ...
    (shell-pop git-gutter-fringe+ gnuplot gnuplot-mode slack yasnippet-classic-snippets eldoc-overlay-mode evil-escape mo-git-blame minimap hideshowvis frame-cmds cygwin-mount cycle-quotes compact-docstrings ascii)))
