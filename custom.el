(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (regex-tool yasnippet async dash web-mode s virtualenvwrapper use-package undo-tree term-manager projectile term-projectile solarized-theme smartparens macrostep slime js2-mode f python-mode puppet-mode pip-requirements flycheck omnisharp notmuch multiple-cursors markdown-mode magit-popup magit js2-refactor helm-core helm helm-projectile helm-ag groovy-mode flycheck-package expand-region evil-commentary beacon aggressive-indent ace-window evil-escape yaml-mode writeroom-mode unicode-troll-stopper toggle-quotes tern-auto-complete tea-time tagedit sublimity string-inflection speed-type smart-tabs-mode skewer-reload-stylesheets scss-mode sane-term rainbow-mode pyimpsort pyenv-mode popwin php-auto-yasnippets nginx-mode names multi-term mocha-snippets mo-git-blame minimap md-readme literate-coffee-mode know-your-http-well key-chord json-mode jscs js-doc jedi iss-mode hideshowvis helm-swoop helm-ls-git helm-git-files gitignore-mode gitconfig-mode gitattributes-mode git-timemachine frame-cmds focus-autosave-mode flycheck-css-colorguard exec-path-from-shell evil-tutor evil-surround evil-nerd-commenter evil-matchit evil-magit evil-leader evil-indent-textobject evil-exchange esup elisp-slime-nav el2markdown editorconfig diffview cygwin-mount cycle-quotes compact-docstrings cask-mode buttercup browse-url-dwim browse-kill-ring bats-mode backup-walker auto-compile ascii apache-mode aggressive-fill-paragraph ag ace-jump-mode ac-slime ac-ispell ac-html-csswatcher ac-html ac-helm ac-emmet)))
