;;; sidecar-locals-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
This creates a buffer with links that visit that file." t)
(function-put 'sidecar-locals-report 'important-return-value 'nil)
...
`Sidecar-Locals mode' mode.  If the prefix argument is positive, enable
...
(provide 'sidecar-locals-autoloads)
