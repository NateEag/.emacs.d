(custom-set-variables
 ...
 '(package-selected-packages
   '(git-walktree reveal-in-osx-finder anzu elpl htmlize synosaurus rfc-mode lua-mode bug-hunter lsp-origami goto-line-preview elisp-def git-gutter origami free-keys elpygen dynamic-spaces sicp neotree eldoc-overlay-mode csv string-edit aggressive-fill-paragraph flycheck-css-colorguard nginx-mode git-blamed regex-tool s undo-tree macrostep puppet-mode pip-requirements evil-commentary beacon evil-escape toggle-quotes tern-auto-complete tea-time tagedit sublimity string-inflection smart-tabs-mode skewer-reload-stylesheets scss-mode sane-term rainbow-mode pyimpsort pyenv-mode popwin php-auto-yasnippets names mo-git-blame minimap md-readme literate-coffee-mode know-your-http-well key-chord jscs js-doc iss-mode hideshowvis helm-git-files gitignore-mode gitconfig-mode gitattributes-mode frame-cmds focus-autosave-mode evil-tutor evil-leader evil-indent-textobject evil-exchange esup elisp-slime-nav el2markdown diffview cygwin-mount cycle-quotes compact-docstrings cask-mode browse-url-dwim browse-kill-ring bats-mode backup-walker ascii ace-jump-mode ac-slime ac-ispell ac-html-csswatcher ac-html ac-helm ac-emmet shell-pop git-gutter-fringe+ gnuplot gnuplot-mode slack yasnippet-classic-snippets))
