...
(let ((load-file-name "/Users/neagleson/.emacs.d/elpa/visual-fill-column-20210419.857/visual-fill-column-autoloads.el"))

(add-to-list 'load-path (directory-file-name
                         (or (file-name-directory "/Users/neagleson/.emacs.d/elpa/visual-fill-column-20210419.857/visual-fill-column-autoloads.el") (car load-path))))
